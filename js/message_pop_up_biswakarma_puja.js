...
const autoCloseAfter2 = 2 * 60 * 1000; // 2 minutes

const noticeData2 = {
    title: "🛠️✨ শুভ বিশ্বকর্মা পুজো ✨🛠️",
    message: `
    ...
    দেবশিল্পী বিশ্বকর্মার আশীর্বাদে আপনাদের কর্মজীবন আরও সুন্দর, নিরাপদ এবং সফল হোক।
    আপনাদের সমস্ত কাজে আসুক অভাবনীয় সাফল্য।<br><br>
...
function showNotice() {
    ...
    document.getElementById("noticeTitle").innerHTML = noticeData2.title;
    document.getElementById("noticeMessage").innerHTML = noticeData2.message;
    document.getElementById("noticeTime").textContent =
    "Valid till: " + noticeEnd2.toLocaleString();
    ...
    "linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.9)), url('images/vishwakarma_puja.png')";
    ...
    // Auto close
    setTimeout(closeNotice, autoCloseAfter2);
...
const noticeChecker2 = setInterval(() => {
    const now = new Date();
    if (now >= noticeStart2 && now <= noticeEnd2) {
        showNotice();
        buildFlowerMala();
        clearInterval(noticeChecker2); // stop checking once shown
    }
